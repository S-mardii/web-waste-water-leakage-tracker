...
@section('body')
    <div class="container">
        ...
        <div class="py-3">
            <p> OD4D Cambodia (Open Data for Development) built the od4d-cambodia app as an Open Source app. This SERVICE is provided by OD4D Cambodia at no cost and is intended for use as is.
            </p>
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible
                at od4d-cambodia unless otherwise defined in this Privacy Policy.
            </p>
            ...
            <p>The app does use third party services that may collect information used to identify you.</p>            <div>
                ...
                <ul>
                    <li>
                        <a href="https://www.google.com/policies/privacy/" target="_blank">Google Play Services
                        </a>
                    </li>
                </ul>
            </div>
